...
<header class="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
    <div class="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div class="hidden items-center gap-3 md:flex">
            ...
            <button class="border border-border text-foreground hover:bg-secondary px-4 py-2 rounded">Iniciar Sesión</button>
            <button class="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded">Registrarse</button>
        </div>
